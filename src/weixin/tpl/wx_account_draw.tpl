    ...
    <div class="wx_draw">
      ...
      <div class="wx_deal_pw_form wx-line">
        <div class="input-box wx_deal_box">
          ...
          <div class="wx_bank_auth_box"><input class="input-text-2 input-no-icon input-select sel sel-cur" type="text" value="选择开户省份" id="province" name="province" readonly="readonly" data-id="" onfocus="this.blur();return false;" /></div>
        </div>
        <div class="input-box wx_deal_box">
          <label class="label label-fl">开户城市</label>
           <div class="wx_bank_auth_box"><input class="input-text-2 input-no-icon input-select input-select-disabled sel sel-cur" type="text" value="选择开户城市" id="city" name="city" readonly="readonly" data-id="" data-type="<%=banktype%>" onfocus="this.blur();return false;" /></div>
        ...
        <div class="input-box wx_deal_box">
          ...
          <div class="wx_bank_auth_box"><input class="input-text-2 input-no-icon input-select input-select-disabled sel sel-cur" type="text" value="选择开户支行" id="branch" name="branch" readonly="readonly" data-id="" onfocus="this.blur();return false;" /></div>
